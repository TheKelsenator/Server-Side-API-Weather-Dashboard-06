...
let getWeatherData = () => {
  ...
  // let stateAbbreviation = usStateCodes.getStateCodeByStateName(userSearch);
  // if (!stateAbbreviation) {
  //   userSearch = usStateCodes.getStateNameByStateCodes(citySearch);
  // } else {
  //   userSearch = stateAbbreviation;
  // }

  let weatherApiInformation = "https://api.openweathermap.org/data/2.5/weather?q=" + userSearch + "&appid=" + APIKey + '&units=imperial'; 
  // API parameters that allows user to receive weather info
